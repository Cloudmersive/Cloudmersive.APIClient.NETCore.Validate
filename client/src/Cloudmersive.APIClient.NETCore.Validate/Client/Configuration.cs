...
namespace Cloudmersive.APIClient.NETCore.Validate.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/2.1.5/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/2.1.5/csharp"
        ...
        {
            String report = "C# SDK (Cloudmersive.APIClient.NETCore.Validate) Debug Report:\n";
            report += "    OS: " + System.Runtime.InteropServices.RuntimeInformation.OSDescription + "\n";
            report += "    Version of the API: v1\n";
            report += "    SDK Package Version: 2.1.5\n";

...
namespace Cloudmersive.APIClient.NETCore.Validate.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ValidateUrlRequestSyntaxOnly :  IEquatable<ValidateUrlRequestSyntaxOnly>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ValidateUrlRequestSyntaxOnly);
        }

        /// <summary>
        /// Returns true if ValidateUrlRequestSyntaxOnly instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateUrlRequestSyntaxOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateUrlRequestSyntaxOnly input)
        {
            if (input == null)
                return false;

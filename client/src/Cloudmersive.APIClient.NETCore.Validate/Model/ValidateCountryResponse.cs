...
namespace Cloudmersive.APIClient.NETCore.Validate.Model
{
    ...
    public partial class ValidateCountryResponse :  IEquatable<ValidateCountryResponse>, IValidatableObject
    {
        ...
        public ValidateCountryResponse(bool? Successful = default(bool?), string CountryFullName = default(string), string ISOTwoLetterCode = default(string), string FIPSTwoLetterCode = default(string), string ThreeLetterCode = default(string))
        {

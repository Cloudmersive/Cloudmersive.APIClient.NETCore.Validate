...
namespace Cloudmersive.APIClient.NETCore.Validate.Model
{
    ...
    public partial class FullNameValidationRequest :  IEquatable<FullNameValidationRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Full name to process as a free-form string; supports many components such as First Name, Middle Name, Last Name, Title, Nickname, Suffix, and Display Name</value>
        [DataMember(Name="FullNameString", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FullNameString: ").Append(FullNameString).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as FullNameValidationRequest);
        }

        /// <summary>
        /// Returns true if FullNameValidationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FullNameValidationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FullNameValidationRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.FullNameString == input.FullNameString ||
                    (this.FullNameString != null &&
                    this.FullNameString.Equals(input.FullNameString))
                );
        }

...
namespace Cloudmersive.APIClient.NETCore.Validate.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class XxeDetectionBatchResponse :  IEquatable<XxeDetectionBatchResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XxeDetectionBatchResponse" /> class.
        /// </summary>
        /// <param name="resultItems">Results from performing a batch XSS protection operation.</param>
        public XxeDetectionBatchResponse(List<XxeDetectionResult> resultItems = default(List<XxeDetectionResult>))
        {
        ...
        public List<XxeDetectionResult> ResultItems { get; set; }
        ...
        {
            return this.Equals(input as XxeDetectionBatchResponse);
        }

        /// <summary>
        /// Returns true if XxeDetectionBatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of XxeDetectionBatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XxeDetectionBatchResponse input)
        {
            if (input == null)
                return false;

...
namespace Cloudmersive.APIClient.NETCore.Validate.Api
{
    ...
    public partial class UserAgentApi : IUserAgentApi
    {
        ...
        /// <returns></returns>
        public UserAgentApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< UserAgentValidateResponse > UserAgentParseWithHttpInfo (UserAgentValidateRequest request)
        {
            ...
            return new ApiResponse<UserAgentValidateResponse>(localVarStatusCode,
                ...
                (UserAgentValidateResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(UserAgentValidateResponse)));
        }

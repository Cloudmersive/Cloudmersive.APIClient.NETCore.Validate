...
namespace Cloudmersive.APIClient.NETCore.Validate.Api
{
    ...
    public partial class DomainApi : IDomainApi
    {
        ...
        /// <returns></returns>
        public DomainApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< CheckResponse > DomainCheckWithHttpInfo (string domain)
        {
            ...
            {
                localVarPostBody = Configuration.ApiClient.Serialize(domain); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse< ValidateUrlResponseFull > DomainUrlFullWithHttpInfo (ValidateUrlRequestFull request)
        {
            ...
            return new ApiResponse<ValidateUrlResponseFull>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ValidateUrlResponseFull) Configuration.ApiClient.Deserialize(localVarResponse, typeof(ValidateUrlResponseFull)));
        }
